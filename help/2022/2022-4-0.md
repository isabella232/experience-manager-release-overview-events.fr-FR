...
# AEM mise à jour de la version 2022.4.0 as a Cloud Service
...
* Sites
   * Publication de fragments d’expérience pour la prévisualisation
...
* Sites
   * Améliorations de la structure d’intégration de Commerce pour rendre les composants marketing Shoppables
* Screens
   * Attribution de canaux en bloc

Vous avez des questions sur la version ?  Discutez de la version dans [Communautés d’Experience League](https://adobe.ly/3LO0gOo).
